 ...
 * @since 1.0
 */
@Component(service = ContainerRequestFilter.class, configurationPid = GithubWebhookSignatureFilter.CONFIG_PID, configurationPolicy = ConfigurationPolicy.REQUIRE)
@JakartarsExtension
