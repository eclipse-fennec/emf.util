 ...
 *
 * @deprecated Moved to the {@code eclipse-fennec/event.atlas} repository (same BSN and
 * packages, Maven group {@code org.eclipse.fennec.event.atlas}). This copy is frozen;
