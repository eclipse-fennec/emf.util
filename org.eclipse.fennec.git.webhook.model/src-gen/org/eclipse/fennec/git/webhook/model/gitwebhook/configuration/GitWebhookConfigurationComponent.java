 ...
 */
package org.eclipse.fennec.git.webhook.model.gitwebhook.configuration;
...
import org.eclipse.fennec.git.webhook.model.gitwebhook.GitWebhookFactory;
import org.eclipse.fennec.git.webhook.model.gitwebhook.GitWebhookPackage;

import org.eclipse.fennec.git.webhook.model.gitwebhook.impl.GitWebhookPackageImpl;

import org.eclipse.fennec.git.webhook.model.gitwebhook.util.GitWebhookResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.git.webhook.model.gitwebhook.util.GitWebhookResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.eclipse.fennec.git.webhook.model.gitwebhook.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.git.webhook.model.gitwebhook.GitWebhookFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.git.webhook.model.gitwebhook\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.git.webhook.model.gitwebhook.GitWebhookPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.git.webhook.model.gitwebhook\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.git.webhook.model.gitwebhook\"" })
