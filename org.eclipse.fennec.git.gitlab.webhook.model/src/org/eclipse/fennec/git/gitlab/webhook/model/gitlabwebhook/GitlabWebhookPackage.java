 ...
 */
package org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabWebhookFactory
 * @model kind="package"
 *        annotation="Version value='1.0'"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel complianceLevel='17.0' oSGiCompatible='true' basePackage='org.eclipse.fennec.git.gitlab.webhook.model' resource='XMI' copyrightText='Copyright (c) 2012 - 2026 Data In Motion and others.\nAll rights reserved.\n\nThis program and the accompanying materials are made\navailable under the terms of the Eclipse Public License 2.0\nwhich is available at https://www.eclipse.org/legal/epl-2.0/\n\nSPDX-License-Identifier: EPL-2.0\n\nContributors:\n    Data In Motion - initial API and implementation'"
 * @generated
 */
@ProviderType
@EPackage(uri = GitlabWebhookPackage.eNS_URI, fingerprint = "fp1:5571c70d16f2c639153394df2b8fabd0b3347c6c48157d949bb34434b857f0e1", genModel = "/model/gitlab-webhook.genmodel", genModelSourceLocations = {"model/gitlab-webhook.genmodel","org.eclipse.fennec.git.gitlab.webhook.model/model/gitlab-webhook.genmodel"}, ecore = "/model/gitlab-webhook.ecore", ecoreSourceLocations = "/model/gitlab-webhook.ecore")
public interface GitlabWebhookPackage extends org.eclipse.emf.ecore.EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://eclipse.org/fennec/gitlab/webhook/1.0.0";
	 ...
	 * @generated
	 */
	GitlabWebhookPackage eINSTANCE = org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.GitlabWebhookPackageImpl.init();

	/**
	 * The meta object id for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.GitlabPayloadImpl <em>Gitlab Payload</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.GitlabPayloadImpl
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.GitlabWebhookPackageImpl#getGitlabPayload()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.ProjectImpl <em>Project</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.ProjectImpl
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.GitlabWebhookPackageImpl#getProject()
	 * @generated
	 */
	int PROJECT = 1;
	...
	/**
	 * Returns the meta object for class '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload <em>Gitlab Payload</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Gitlab Payload</em>'.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload
	 * @generated
	 */
	EClass getGitlabPayload();

	/**
	 * Returns the meta object for the containment reference '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getProject <em>Project</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Project</em>'.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getProject()
	...
	/**
	 * Returns the meta object for the containment reference list '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getCommits <em>Commits</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Commits</em>'.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getCommits()
	 * @see #getGitlabPayload()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getProvider() <em>Get Provider</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Provider</em>' operation.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getProvider()
	 * @generated
	 */
	EOperation getGitlabPayload__GetProvider();

	/**
	 * Returns the meta object for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getCloneUrl() <em>Get Clone Url</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Clone Url</em>' operation.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getCloneUrl()
	 * @generated
	 */
	EOperation getGitlabPayload__GetCloneUrl();

	/**
	 * Returns the meta object for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getRepositoryFullName() <em>Get Repository Full Name</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Repository Full Name</em>' operation.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getRepositoryFullName()
	 * @generated
	 */
	EOperation getGitlabPayload__GetRepositoryFullName();

	/**
	 * Returns the meta object for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getAddedPaths() <em>Get Added Paths</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Added Paths</em>' operation.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getAddedPaths()
	 * @generated
	 */
	EOperation getGitlabPayload__GetAddedPaths();

	/**
	 * Returns the meta object for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getModifiedPaths() <em>Get Modified Paths</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Modified Paths</em>' operation.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getModifiedPaths()
	 * @generated
	 */
	EOperation getGitlabPayload__GetModifiedPaths();

	/**
	 * Returns the meta object for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getRemovedPaths() <em>Get Removed Paths</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Removed Paths</em>' operation.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.GitlabPayload#getRemovedPaths()
	 * @generated
	 */
	EOperation getGitlabPayload__GetRemovedPaths();

	/**
	 * Returns the meta object for class '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.Project <em>Project</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Project</em>'.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.Project
	 * @generated
	 */
	EClass getProject();

	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.Project#getGitHttpUrl <em>Git Http Url</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Git Http Url</em>'.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.Project#getGitHttpUrl()
	 * @see #getProject()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.Project#getPathWithNamespace <em>Path With Namespace</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Path With Namespace</em>'.
	 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.Project#getPathWithNamespace()
	 * @see #getProject()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.GitlabPayloadImpl <em>Gitlab Payload</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.GitlabPayloadImpl
		 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.GitlabWebhookPackageImpl#getGitlabPayload()
		...
		/**
		 * The meta object literal for the '{@link org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.ProjectImpl <em>Project</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.ProjectImpl
		 * @see org.eclipse.fennec.git.gitlab.webhook.model.gitlabwebhook.impl.GitlabWebhookPackageImpl#getProject()
