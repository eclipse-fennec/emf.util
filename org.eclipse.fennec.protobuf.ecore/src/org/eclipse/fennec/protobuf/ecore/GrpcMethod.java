 ...
 * + gRPC flavor. Either {@code EClass} may be {@code null} if the message type was not part
 * of the imported set (e.g. a well-known type without {@code --include_imports}).
 *
 * @see GrpcService
